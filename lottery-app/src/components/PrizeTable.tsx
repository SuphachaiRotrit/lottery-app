  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-6xl mx-auto">
      ...
      <div className="glass-card rounded-2xl p-6 md:p-8 border-violet-500/20 hover:border-violet-500/40 transition-all duration-500 group relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-violet-500/5 via-purple-500/5 to-violet-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-linear-to-br from-violet-400 to-purple-600 flex items-center justify-center shadow-lg shadow-violet-500/20">
      ...
      <div className="glass-card rounded-2xl p-6 md:p-8 border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-500 group relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-bold bg-linear-to-r from-cyan-300 to-teal-300 bg-clip-text text-transparent">เลขข้างเคียงรางวัลที่ 1</h3>
      ...
      <div className="lg:col-span-2 glass-card rounded-2xl p-6 md:p-8 border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-500 group relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-bold bg-linear-to-r from-emerald-300 to-green-300 bg-clip-text text-transparent">รางวัลเลขท้าย 2 ตัว</h3>
