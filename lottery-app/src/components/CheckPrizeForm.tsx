      ...
      >
        <div className="relative w-full sm:w-auto">
          <input
            ...
            id="check-input"
            className="w-full sm:w-72 px-6 py-4 text-2xl text-center number-display bg-white border-2 border-slate-200 rounded-xl focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 placeholder:text-slate-300 text-slate-800 transition-all duration-300 hover:border-slate-300 shadow-sm"
          />
        </div>
        ...
        <button
          onClick={handleCheck}
          id="btn-check"
          className="w-full sm:w-auto px-8 py-4 rounded-xl font-semibold text-lg bg-primary hover:opacity-90 text-white shadow-lg shadow-primary/25 transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
        >
            ...
            <div className="glass-card rounded-2xl p-6 border-emerald-200 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-lg text-slate-700">
                  หมายเลข{' '}
                  <span className="number-display text-xl font-bold text-primary bg-primary/5 px-3 py-1 rounded-lg">
                    {result.number}
                  </span>
                </p>
