          ...
          {result?.isWinner ? (
            <>
              ...
              <div className="bg-indigo-50 rounded-2xl p-4 mb-6 border border-indigo-100">
                <p className="text-xs text-indigo-400 uppercase tracking-widest font-bold mb-1">หมายเลขของคุณ</p>
                <p className="text-4xl font-black text-indigo-600 number-display tracking-widest">{result.number}</p>
              </div>
